...
namespace XFramework.Validations
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return XFramework.Helpers.Convert.ToBool(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToBoolOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToInt(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToIntOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToLong(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToLongOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToDouble(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToDoubleOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToDecimal(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToDecimalOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToDate(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToDateOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToGuid(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToGuidOrNull(obj);
        }
        ...
        {
            return XFramework.Helpers.Convert.ToGuidList(obj);
        }
